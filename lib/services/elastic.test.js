...
describe(filename, () => {
  ...
  describe('scrollStream', () => {
    ...
    test('returns scroll stream constructed with client and specified opts', () => {
      ...
      expect(mockElasticSearchScrollStream.mock.calls[0][0]).toEqual(lib.client);
      expect(mockElasticSearchScrollStream.mock.calls[0][1]).toEqual({baz: 'zar'});
      expect(mockElasticSearchScrollStream.mock.calls[0][1]).toEqual({baz: 'zar'});
