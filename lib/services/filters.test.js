...
describe(filename, () => {
  ...
  describe('filterRefs', () => {
    test('takes an operation and removes refs from it', () => {
      ...
      expect(lib.filterRefs(op)).to.deep.equal({
        type: 'put',
        key: 'www.vulture.com/_components/article/instances/section-test',
        value: { primaryHeadline: 'some headline' }
      });
    });
  });
});
...
//     describe('isNotPublished', function () {
//       let fn = lib[this.title];
...
//       it('takes an operation and returns true if its key does not have a published ref', function () {
//         let op = {
//           type: 'get',
//           key: 'www.vulture.com/_components/sailthru-personalization-pixel',
//           value: '{}'
...
//         let op = {
//           type: 'put',
//           key: 'www.nymag.com/scienceofus/_pages/cit0k8p6x0000r7reetki2i6k@scheduled',
//           value: '{}'
//         };
...
//         let op = {
//           type: 'put',
//           key: 'www.nymag.com/scienceofus/_pages/cit0k8p6x0000r7reetki2i6k',
//           value: '{}'
//         };
...
//         let op = {
//           type: 'put',
//           key: 'www.vulture.com/_components/sailthru-personalization-pixel@published',
//           value: '{}'
//         };
